...
public abstract class AbstractPingPongResourceTest {
    ...
    public void testPingPongWithPathParam() {
        ...
        given().auth().oauth2(createToken())
                ...
                .then().statusCode(HttpStatus.SC_OK).log().body().body(containsString("ping pong " + name));
    }
    ...
    public void testPingPongCreate() {
        ...
        given().auth().oauth2(createToken())
                ...
                .then().statusCode(HttpStatus.SC_OK).log().body().body(containsString("ping -> " + score.toString()));
    }
    ...
    public void testPingPongDelete() {
        given().auth().oauth2(createToken())
                ...
                .then().statusCode(HttpStatus.SC_OK).log().body().body(containsString("ping -> true"));
    }
