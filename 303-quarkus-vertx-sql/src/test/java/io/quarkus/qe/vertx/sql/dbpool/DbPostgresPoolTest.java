...
public class DbPostgresPoolTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(DbPostgresPoolTest.class);
                    ...
                    .concatMap(n -> {
                        ...
                        return postgresql.preparedQuery("SELECT CURRENT_TIMESTAMP")
                                .execute().onFailure().invoke(error -> {
                                    ...
                                    latch.countDown();
                                    Assertions.assertTrue(false, error.getMessage());
